...
public class Step1 {
    ...
    public static void main(String[] args) {
        ...
        // - 래퍼 클래스: 기본타입 --> 참조타입 , 기본 타입을 참조타입으로 만들기
       ...
       // value1. //도트 연산자를 사용할 수 없다.
        ...
        value2.intValue();                       // 도트 연산자를 사용할 수 있다.(참조타입, 크래스
        ...
        //===문자열 타입을 기본타입으로 반환: 주로 자바외 데이터를 가져올 때===//
       ...
       // 4. 오토박싱 , 언박싱
        ...
        //String 클래스의 모든 필드 정보( 선언부) 호출
        Field[] fields= c.getFields();
        for (Field f:fields){
            System.out.println("f = " + f);
        }
        
        //String 클래스의 모든 함수 정보( 선언부 ) 호출
        ...
        System.out.println("p2 = " + p2);//example.day06.Person@421faab1

        try {
            Class pClass= Class.forName("example.day06.Person");
            Person p3= (Person)pClass.newInstance();
            System.out.println("p3 = " + p3); //example.day06.Person@2b71fc7e
        }catch (Exception e){
            System.out.println("e = " + e);
        }
