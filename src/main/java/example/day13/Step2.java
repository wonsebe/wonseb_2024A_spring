...
public class Step2 {
    ...
    public static void main(String[] args) {
        ...
        scores.add(10);  scores.add(15);
        scores.add(48);  scores.add(22);
        scores.add(7);
        scores.add(56);
        ...
        //5. 트리 관련 메소드 제공
        System.out.println("가장 낮은 점수, 가장 왼쪽 = " + scores.first());
        System.out.println("가장 높은 점수 ,가장 오른쪽 = " + scores.last());
        System.out.println("48보다 아래점수 = " + scores.lower(48));
        System.out.println("48보다 큰 점수 = " + scores.higher(48));
        System.out.println("48이거나 보다 아래 점수 = " + scores.floor(48));
        System.out.println("48이거나 보다 위 점수 = " + scores.ceiling(48));
        
        System.out.println("내림차순으로 반환 = " + scores.descendingSet()); //내림 차순
        ...
        System.out.println("treeMap.tailMap(48) = " + treeMap.tailMap(48 ,true));
        System.out.println("treeMap.headMap(48) = " + treeMap.headMap(48, true));
